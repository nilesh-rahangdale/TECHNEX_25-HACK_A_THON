...
(1, 'Pranav', 'G', 'Shahakar', 'Male', 2025, 1, 'pranavs.etc21@sbjit.edu.in', 'SBJITMR', '1602730260_avatar.jpg', 1, '2024-10-09');
...
INSERT INTO `student_bio` (`id`, `firstname`, `middlename`, `lastname`, `gender`, `year`, `course_id`, `email`, `connected_to`, `avatar`, `status`, `date_created`) VALUES
(2, 'Pranav', 'G', 'Shahakar', 'Male',1, 1, 'pranavshahakar88@gmail.com', '', '1602730260_avatar.jpg', 1, '2024-10-09');
...
(1, 'Electronics And Telecommunication', 'Sample'),
(2, 'Computer Science', 'Sample'),
(3, 'Artificial Intelligence & Data Science', 'Sample'),
(4, 'Artificial Intelligence & Machine Learning', 'Sample'),
(5, 'Electrical Engineering', 'Sample'),
(6, 'Mechanical Engineering', 'Sample');
...
(1, 'Garbotsav-2K24', '🌟𝐆𝐚𝐫𝐛𝐚, a vibrant and rhythmic dance, is a beautiful cultural celebration that unites people in joy and tradition', '2024-10-11 16:00:00', 'admin\assets\uploads\gallery\1728468900_garbaeve.jpg', '2024-10-09 09:51:55');
...
(3, 3, 'Sample', 1, '2024-10-8 08:48:02'),
(5, 0, '', 1, '2024-10-8 09:49:34');
...
(1, 'Alumni Portal: Your Gateway to Alumni Connection', 'Alumni@gmail.comm', '7775038456', 'admin\assets\uploads\1728465360_College_img.jpg', 'An alumni network platform is a digital tool designed to facilitate engagement and communication among graduates of an educational institution. These platforms aim to strengthen 
the connection between alumni and their alma mater by providing features that support 
networking, professional development, and community building.');
...
CREATE TABLE `users` (
  ...
  `type` tinyint(1) NOT NULL DEFAULT 3 COMMENT '1=Admin,2=Alumni,3= student',
...
INSERT INTO `users` (`id`, `name`, `username`, `password`, `type`, `auto_generated_pass`, `alumnus_id`, `student_id`, `reset_token_hash`, `reset_token_expires_at`) VALUES
(1, 'Admin', 'admin', '0192023a7bbd73250516f069df18b500', 1, '', '', '', 'abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890', '2024-11-10 12:00:00');
