                    ...
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="">
                                ...
                                <p class="filter-txt">Year: <b><?php echo $row['year'] ?></b></p>
...
<script>
    // $('.card.student-list').click(function(){
    //     location.href = "index.php?page=view_student&id="+$(this).attr('data-id')
    // })
    $('.book-student').click(function(){
        uni_modal("Submit Booking Request","booking.php?student_id="+$(this).attr('data-id'))
    })
    $('.student-img img').click(function(){
