...
<?php
if(isset($_GET['id'])){
$qry = $conn->query("SELECT a.*,c.course,Concat(a.lastname,', ',a.firstname,' ',a.middlename) as name from student_bio a inner join courses c on c.id = a.course_id where a.id= ".$_GET['id']);
